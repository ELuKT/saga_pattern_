...
//        template.setMessageConverter(new Jackson2JsonMessageConverter());
    ...
    public Jackson2JsonMessageConverter jsonConverter() {
        ...
        mapping.put("orchestrator.bean.message.UpdateOrderMessage", UpdateOrderMessage.class);
        mapping.put("orchestrator.bean.message.CancelOrderMessage", CancelOrderMessage.class);
